...
namespace carShopDllProject
{
    ...
    public abstract class Veicolo
    {
        ...
        public Veicolo(string marca, string modello, string colore, int cilindrata, double potenzaKw, DateTime immatricolazione, bool isUsato, bool isKmZero, int kmPercorsi, double prezzo, int id)
        {
            this.Marca = marca;
